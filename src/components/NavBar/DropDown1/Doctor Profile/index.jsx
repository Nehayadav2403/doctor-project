                  ...
                  <div className="row">
                    <div className="col-md-12 col-lg-9">
                      ...
                      <div className="widget about-widget">
                        ...
                        <p>
                          Meeting with patients to discuss and treat dental
                          concerns, perform regular cleanings and other
                          preventative procedures, and establish a plan for
                          better dental hygiene. Performing dental procedures,
                          such as extractions, root canals, and filling
                          cavities. Correcting bite issues and overcrowding.
                          Applying helpful agents to teeth, such as sealants or
                          whiteners. Prescribing medications for dental
                          problems, such as pain medications or antibiotics.
                          Giving clients sedatives or anesthesia prior to
                            ...
                            <li>
                              ...
                              <div className="experience-content">
                                <div className="timeline-content">
                                  ...
                                  <p>
                                    It is not easy to win the Famdent Excellence
                                    in Dentistry Award given the rigorous
                                    judging process; making the Winners true
                                    Stalwarts in their respective categories.
                                  </p>
                                </div>
                              </div>
                            </li>
                            <li>
                              ...
                              <div className="experience-content">
                                <div className="timeline-content">
                                  ...
                                  <p>
                                    The award is presented during the Academy’s
                                    annual meeting.
                                  </p>
                                </div>
                              </div>
                            ...
                            <li>
                              ...
                              <div className="experience-content">
                                <div className="timeline-content">
                                  ...
                                  <p>
                                    This new endeavor was given a very warm
                                    welcome by the Dental Profession on its
                                    debut in 2013 - making it India's most
                                    coveted Dentistry Awards and hailing it as
                                    "the Indian Dental Oscars"!
                                  </p>
                                </div>
                              </div>
                            </li>
